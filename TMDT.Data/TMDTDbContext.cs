...
namespace TMDT.Data
{
    public class TMDTDbContext : IdentityDbContext<AppUser>
    {
        public TMDTDbContext() : base("TMShopConnection")
        {
        ...
        public static TMDTDbContext Create()
        {
            return new TMDTDbContext();
        }
