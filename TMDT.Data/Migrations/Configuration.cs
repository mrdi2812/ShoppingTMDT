namespace TMDT.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TMDT.Data.TMDTDbContext>
    {
        ...
        protected override void Seed(TMDT.Data.TMDTDbContext context)
        {
        ...
        private void CreateFunction(TMDTDbContext context)
        {
        ...
        private void CreateConfigTitle(TMDTDbContext context)
        {
        ...
        private void CreateUser(TMDTDbContext context)
        {
            var manager = new UserManager<AppUser>(new UserStore<AppUser>(new TMDTDbContext()));
            if (manager.Users.Count() == 0)
            {
                var roleManager = new RoleManager<AppRole>(new RoleStore<AppRole>(new TMDTDbContext()));
        ...
        private void CreateProductCategorySample(TMDTDbContext context)
        {
        ...
        private void CreateSize(TMDTDbContext context)
        {
        ...
        private void CreateColor(TMDTDbContext context)
        {
        ...
        private void CreateFooter(TMDTDbContext context)
        {
        ...
        private void CreateSlide(TMDTDbContext context)
        {
        ...
        private void CreatePage(TMDTDbContext context)
        {
        ...
        private void CreateContactDetail(TMDTDbContext context)
        {
            if (context.ContactDetails.Count() == 0)
            {
                try
                {
                    var contactDetail = new TMDT.Model.Models.ContactDetail()
                    {
                        Name = "Shop thời trang",
                        Adderss = "Triều Khúc, Thanh Trì, Hà Nội",
                        Email = "anhtuan281290@gmail.com",
                        Lat = "20.990673",
                        Lng = "105.803016",
                        Phone = "0988135411",
                        Website = "http://shopping.com.vn",
                        Other = "",
                        Status = true
                    };
