...
namespace TMDT.Web.App_Start
{
    ...
    {
        public ApplicationUserStore(TMDTDbContext context)
            : base(context)
        {
        }
    }
    public class ApplicationRoleManager : RoleManager<AppRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<AppRole>(context.Get<TMDTDbContext>()));
        }
    }
    ...
    public class ApplicationUserManager : UserManager<AppUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AppUser>(context.Get<TMDTDbContext>()));
